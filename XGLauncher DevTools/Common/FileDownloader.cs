...
namespace XGL.Networking {
    ...
    public class GDFileDownloader : IDisposable  {
        ...
        public void DownloadFile(string address, string fileName) => DownloadFile(address, fileName, false, null);

        public void DownloadFileAsync(string address, string fileName, object userToken = null) => DownloadFile(address, fileName, true, userToken);
